...
## 
## Makefile     : control.mk
## Generated on : Tue Apr 07 17:25:52 2026
...
START_DIR                 = C:/Users/Mutti/Documents/Hyperloop
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
stm32h7xx_ll_exti.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_ll_exti.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
stm32h7xx_ll_rcc.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_ll_rcc.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
stm32h7xx_ll_usart.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_ll_usart.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
startup_stm32h723zgtx.s.o : $(START_DIR)/STM32CubeIDE/Application/User/Startup/startup_stm32h723zgtx.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
